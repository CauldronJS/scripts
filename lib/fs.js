...
exports.mkdirSync = function(dir, mode) {
  return __cauldron__.getFile(dir).mkdirs();
};
...
exports.readdirSync = function(dir, options) {
  const directory = __cauldron__.getFile(dir);
...
const _writeString = function(fd, string, position, encoding) {
  const file = __cauldron__.getFile(fd);
  file.createNewFile();
...
exports.writeFileSync = function(file, data, options) {
  const f = __cauldron__.getFile(file);
  f.createNewFile();
...
exports.new = function(location, data) {
  const file = __cauldron__.getFile(location);
  file.createNewFile();
  const fOut = new BufferedWriter(
...
exports.mkdirs = function(directory) {
  __cauldron__.getFile(directory).mkdirs();
};

exports.isPath = function(location) {
  return __cauldron__.getFile(location).isDirectory();
};

exports.isFile = function(location) {
  return __cauldron__.getFile(location).isFile();
};
