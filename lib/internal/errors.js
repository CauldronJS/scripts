...
const messages = new java.util.HashMap();
const codes = {};
...
function getMessage(key, args) {
  ...
  const expectedLength = (msg.match(/%[dfijo0s]/g) || []).length;
  assert(
...
E(
  ...
  'File size (%s) is greater than possible Buffer: ' + kMaxLength + ' bytes',
  RangeError
);
E(
...
E('ERR_SOCKET_BUFFER_SIZE', 'Could not get or set buffer size', Error);
