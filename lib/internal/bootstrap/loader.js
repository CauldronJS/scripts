...
(function() {
  ...
  // TODO: actually fucking test this
  ...
  class NativeModule {
    ...
    static require(id) {
      ...
      const jpkg = NativeModule.fromJava(id);
      if (jpkg) {
        return jpkg;
      }
      const rpkg = NativeModule.fromResolver(id);
      if (rpkg) {
        return rpkg;
      }
    ...
    static fromJava(request) {
      const normalized = request.replace(/\/\\/g, '.');
      return tryGetJavaObject(normalized);
    }

    static fromResolver(request) {
