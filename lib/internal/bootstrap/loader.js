...
console.log($$cauldron$$.getDataFolder());
  ...
  function tryGetJavaObject(request) {
    try {
      ...
      const fallbackPackage = $$cauldron$$
        .isolate()
        .runScript(`Packages.${request}`, 'internal/bootstrap/loaders.js');
      return Object.keys(fallbackPackage).length > 0 ? fallbackPackage : null;
    }
  }
