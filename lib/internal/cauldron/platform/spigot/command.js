 ...
 */
function registerCommand(name, args) {
...
CauldronCommand.registerCommand = registerCommand;
CauldronCommand.unregisterCommand = unregisterCommand;
CauldronCommand.clearCommands = clearCommands;
